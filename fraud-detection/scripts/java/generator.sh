...
# Generates random transaction events to Kafka topic
...
CLASS="com.wslimi.demo.fraud.TransactionDataGeneratorApp"
PARALLELISM="${1:-3}"
...
echo "Deploying Transaction Generator (parallelism: $PARALLELISM)"
...
echo "Output topic: transactions"
