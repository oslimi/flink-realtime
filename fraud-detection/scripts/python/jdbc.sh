...
PYTHON_SCRIPT="$PROJECT_ROOT/fraud-detection/src/main/python/scripts/jdbc_sink_demo.py"
...
echo "Deploying JDBC Sink Demo (Python, parallelism: $PARALLELISM)"
...
flink run -d \
  ...
  -py /opt/flink/pyflink/python/scripts/jdbc_sink_demo.py
"

echo ""
echo "Job submitted!"
echo "Check Flink UI: http://localhost:8081"
echo "Database sink: PostgreSQL"
